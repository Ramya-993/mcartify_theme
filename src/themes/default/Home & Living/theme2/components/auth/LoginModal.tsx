  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-white cursor-pointer text-(color:--primary) shadow-lg hover:shadow-xl transition-all duration-200 rounded-xl px-4 h-10 font-semibold text-sm">
