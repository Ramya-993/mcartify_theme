  ...
  return (
    <div className="md:px-4 px-2 flex flex-col">
                  ...
                  <div className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="flex items-center gap-2">
                        <span className="font-semibold font-(family-name:--font-secondary)">
                      ...
                      <div className="absolute top-2 right-2 flex items-center *:cursor-pointer *:rounded *:p-1 *:transition">
                        ...
                        <div
                          onClick={(e) => {
                            e.stopPropagation();
                            // @ts-expect-error addressId is expected to be passed to deleteAddress
                    ...
                    <p className="text-xs text-gray-600 font-(family-name:--font-primary)">
      ...
      <button className="group flex items-end justify-end mt-2 text-sm text-right text-blue-500">
        <span
          className="group-hover:underline font-(family-name:--font-primary)"
          onClick={() => {
            dispatch(
              updatePopModalData({
                content: <AddAddress />,
