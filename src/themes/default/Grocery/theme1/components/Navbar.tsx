...
const EnhancedSearchBox = memo(
  ({
    ...
    return (
      ...
      >
        <div className="relative group shadow-none border rounded-(--radius-lg)">
                ...
                {searchResults.length > 0 ? (
                  searchResults.map((result, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 p-3 hover:bg-green-50 cursor-pointer border-b last:border-b-0 group transition-all duration-200"
    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            <span className="font-(weight:--navbar-category-text-weight) text-(color:--navbar-category-text-color) text-(size:--navbar-category-text-size) font-(family-name:--font-secondary)">
                ...
                category.subcategories.length > 0 ? (
                  ...
                  >
                    <div className="p-2 bg-(color:--primary) rounded-lg">
                      <Grid3X3 className="h-3 w-3 text-(color:--primary)" />
                    </div>
                    <span className="font-medium text-(color:--primary) text-sm">
                      {category.name}
                    </span>
    ...
    >
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <ShoppingCart className="h-[var(--mobile-menu-item-icon-size)] w-[var(--mobile-menu-item-icon-size)] text-[var(--primary)]" />
            <AnimatePresence>
              {cartItemCount > 0 && (
                <motion.div
                  initial={{ scale: 0 }}
...
const EnhancedMobileSidebar = ({
  ...
  console.log("isLoggedIn12356", isLoggedIn);
  console.log("customer12356", customer);
  return (
  ...
  return (
    <TooltipProvider>
      ...
      >
              ...
              >
                ...
                >
                  ...
                  <div className="truncate">
                    <h1 className="text-base  md:text-lg font-(family-name:--font-primary) font-bold bg-(color:--primary) bg-clip-text text-transparent truncate">
                      {store.Store.storeName}
                    </h1>
                  </div>
                </div>
        ...
        <motion.div
          className="hidden md:block bg-gradient-to-r from-gray-50 to-green-50/30 border-b border-gray-200 shadow-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
                    ...
                    return (
                      ...
                      >
                        <Button
                          ...
                          size="sm"
                          className={cn(
                            "relative overflow-hidden hover:text-(color:--primary) hover:bg-(color:--primary-light) transition-all duration-300 rounded-xl px-4 h-9 font-semibold text-sm group",
                            isActive
                        ...
                        >
                          ...
                          {isActive && (
                            <motion.div
                              layoutId="activeTab"
                              className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-(color:--primary) to-(color:--primary-hover)"
                              initial={false}
                              transition={{
                                type: "spring",
                                stiffness: 500,
