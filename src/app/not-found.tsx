  ...
  return (
    <section className="">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="inline-flex w-full flex-col items-center justify-start gap-10 pt-12 pb-12 lg:gap-16 lg:pb-28">
          <div className="h-[550px] w-full rounded-lg border border-emerald-300">
            <div className="flex items-center justify-between border-b border-emerald-100 p-8">
              <div className="block">
                <svg
                  width="204"
                  height="18"
            ...
            <div className="relative flex h-[calc(550px-85px)] flex-col items-center justify-center">
              ...
              >
                ...
                <path
                  ...
                  fill="#FFFFFF"
                />
                <circle cx="136.191" cy="31.0854" r="1.36752" fill="#FFFFFF" />
              ...
              <div className="mt-5 block text-center">
                <h5 className="mb-1.5 text-lg leading-8 font-medium text-gray-900 md:text-xl">
                  <span className="font-semibold text-emerald-600">Oops!</span>{" "}
                Page Not Found
                </h5>
